...
from .serializers import (
    ...
    Shop, ShopSerializer, Invoice, InvoiceSerializer, InventoryWithSumSerializer, ShopWithAmountSerializer, InvoiceItem
)
from rest_framework.response import Response
from inventory_api.custom_methods import IsAuthenticationCustom
...
class ShopView(ModelViewSet):
    queryset = Shop.objects.select_related("belongs_to", "created_by")
...
class SaleByShopView(ModelViewSet):
    ...
    def list(self, request, *args, **kwargs):
        ...
        if monthly:
            shops = query.annotate(month=TruncMonth('created_at')).values('month', 'name').annotate(amount_total=Sum(
